...
export default function recent() {
  ...
  const emptyImageSource = require("@/assets/pngs/empty-2.png");
  ...
  return (
    <ScrollView className="flex-1 bg-white p-4">
      <View className="mb-6">
        <Text className="font-med text-2xl">Recnet transforms</Text>
      </View>
      {loading ? (
        ...
        <>
          {recent.length > 0 ? (
            ...
            <View className="w-full h-full mt-24 flex justify-center items-center">
              <Image source={emptyImageSource} className="w-[200] h-[200]" />
              <Text className="font-med text-md">Nothing here yet.</Text>
            </View>
          )}
        </>
      )}
